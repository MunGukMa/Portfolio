...
//////////////////////////////////////////////////////////////////////////////////////////////////
	function listhead()
	{
		$('#myorderlist').append('<tr id="listhead"><th>주문번호</th><th>상품이름</th><th>주문일</th><th>주문수량</th><th>총주문금액</th><th>주문상태</th></tr>');
	}
	...
	function mylist()
	{
		...
		({
			...
			success:function(result)
			{
				...
				$(result).each(function(index,item)
						{
							$('#myorderlist').append('<tr class="listbody"><td>'+(index+1)+
									'</td><td>'+item.prdtname+'</td><td>'+item.orderdate+
									'</td><td>'+item.orderqt+'</td><td>'+(item.orderqt*item.prdtprice)+
									'</td><td>'+item.shipstate+'</td></tr>');		
